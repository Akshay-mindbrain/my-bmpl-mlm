import { getAllOrdersRepo, getOrderByIdRepo, updateOrderStatusRepo } from "@/data/repositories/Order.repo";
...
export const updateOrderStatusUsecase = async (id: number, status: OrderStatus) => {
