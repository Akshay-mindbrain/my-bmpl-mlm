...
export const orderCreateSchema = Joi.object({
  paymentMethod: Joi.string().valid("COD", "ONLINE", "WALLET", "DP_WALLET").required(),
...
export const orderUpdateSchema = Joi.object({
  paymentMethod: Joi.string().valid("COD", "ONLINE", "WALLET", "DP_WALLET").optional(),

  address: Joi.object({
    name: Joi.string().max(100),
    phone: Joi.string().max(15),

    addressLine: Joi.string().max(255),
