...
export const getPurchasesByPlan = async (planId: number) => {
...
import { approvePlanPurchase } from "../admin/planPurchaseApproval.useCase";

export const approvePurchase = async (purchaseId: number, adminId: number) => {
  return approvePlanPurchase(purchaseId, adminId);
};
