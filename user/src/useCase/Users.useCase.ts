...
import { countUsersByLineage } from "../data/repositories/Users.Repository";
...
export const getTeamStats = async (userId: number) => {
  if (!userId) {
  ...
  return {
    ...
    total: {
      ...
      totalBV: left.totalBV + right.totalBV,
      totalIncome: left.totalIncome + right.totalIncome,
    },
  };
};
