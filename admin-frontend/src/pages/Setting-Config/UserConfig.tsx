...
export default function UserConfig() {
            ...
            try {
                ...
                if (configRes) {
                    setForm({
                        ...
                        royalPlanIds: configRes.royalQualifierPlans?.map((p: any) => p.id) || [],
                    });
                }
            } catch (err) {
    ...
    const handlePlanChange = (event: any) => {
        ...
        setForm((p) => ({
            ...p,
            royalPlanIds: typeof value === "string" ? value.split(",") : value,
        }));
    };
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            setForm({
                ...
                royalPlanIds: res.royalQualifierPlans?.map((p: any) => p.id) || [],
            });
